...
| 校准与定价诊断 | 2015 年预测违约率 13.63%、实际 14.89%，10 档中 9 档被低估；最低两档分数净收益为负，最低档年化利率约需上调 1.9 个百分点 |
...
- 三层策略：2014 年上网格搜索两个阈值（< 502 拒绝，502–529 加验，≥ 529 直接通过）。收益是分数阈值的阶梯函数，没有可用的梯度，而 200 × 200 的组合全部枚举能保证全局最优。2015 年样本外净收益 $98.0M，比单阈值高 23.8%
...
- 定价诊断：2015 年最低两档分数的净收益为负，最低档年化利率约需上调 1.9 个百分点才能打平，其余各档均盈利
